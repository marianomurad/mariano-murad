...
const LayoutComponent = ({ children }) => {
  return (
    <div className="flex flex-col h-screen w-screen">
      <div className="flex items-center justify-start h-14 float-left w-full py-8 border">
        <a href="/">
          <RiHome2Line style={{ fontSize: 25, marginLeft: 30 }} />
        </a>
      </div>
      ...
      <footer className="flex justify-center items-center border-t-[1px] border-slate-600 h-10">
        ...
        <div className="flex m-4 text-black">
          <a
            ...
            style={{ fontSize: 30, color: "black", margin: 10 }}
          >
            <RiGithubLine />
          </a>
          <a
